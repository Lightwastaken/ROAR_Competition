...
class checkpoints:
    def __init__(self):
        ...
        self.checkpoint_list = [((-240, -220), (770, 810)), ((385, 905), (960, 1000)), ((720, 780), (1010, 1030)), ((730, 750), (700, 740)),
                                ((-10, 10), (80, 120)), ((-95, -55),(-110, -90)), ((-170, -150), (-1070, -1030)), ((-390, -350), (-680, -660)),
                                ((-360, -320), (220, 240))]
    ...
    def update_checkpoints(self, x_coord, y_coord):
        ...
        if -300 < x_coord < -290 and 420 < y_coord < 430 and not self.in_start_box:
        ...
        elif  self.checkpoint_index < len(self.checkpoint_list) and x_coord_min < x_coord < x_coord_max and y_coord_min < y_coord < y_coord_max:
            self.in_start_box = False
